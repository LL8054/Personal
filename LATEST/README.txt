...
Type: TAVG - Monthly
Version: LATEST
Number of Records: 4646
Number of Locations: 4627
Number of Data Points: 1507331
Dataset Hash: 67f81e232bae4826df3d06d1b8a40739

------------------------------------

This is the dataset description for the "World Monthly Surface Station 
Climatology" dataset as represented in the Berkeley Earth Surface Temperature 
Analysis data archive.

World Monthly Surface Station Climatology RAW DATA

This dataset is a representation of the land surface temperature component of 
the World Monthly Surface Station Climatology (WMSSC).  The official dataset is 
presented by the National Center for Atmospheric Research (NCAR; 
http://ncar.ucar.edu/).

The original data files can be found via:
http://dss.ucar.edu/datasets/ds570.0/

The Berkeley Earth Surface Temperature project downloaded these reports and 
